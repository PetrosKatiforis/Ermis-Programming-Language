...
class WrongTypeError(ErmisError):
    """
    Fires when assigning a variable to a different type
    ...
    def __init__(self, name):
        super().__init__(f"Δεν μπορώ να αλλάξω τον τύπο της μεταβλητής <<{name}>>!")
...
class MissingFunctionParameter(ErmisError):
    ...
    def __init__(self, name):
        super().__init__(f"Το κάλεσμα της συνάρτησης {name} δεν έχει τις απαρέτητες παραμέτρους...")
